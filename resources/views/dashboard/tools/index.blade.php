    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-start">
            ...
            <p class="text-gray-600 mb-4">
                Update and manage the difficulty of questions in bulk.
            </p>
        ...
        <div class="bg-white shadow-lg  rounded-lg p-6 flex flex-col items-start">
            ...
            <p class="text-gray-600 mb-4">
                Check and update the relevancy of questions in bulk.
            </p>
...
{{--            <h2 class="text-xl font-semibold mb-2">Categorisation Tool</h2>--}}
{{--            <p class="text-gray-600 mb-4">--}}
{{--                Assign or adjust categories for batches of questions.--}}
{{--            </p>--}}
{{--            <a href="{{ route('dashboard.tools.categorisation') }}"--}}
